...
export default function AuthPage() {
  ...
  return (
    <div className="flex w-full min-w-[375px] flex-1 flex-col items-center justify-center p-0 transition-[padding] ease-in-out lg:px-32 lg:py-16 xl:px-64">
      <div className="flex h-full w-full flex-1 flex-col rounded-none border-gray-300 bg-[var(--color-page-background)] p-9 dark:border-gray-700 dark:bg-[var(--color-background)] dark:shadow-none lg:rounded-3xl lg:border lg:bg-white lg:shadow-xl">
